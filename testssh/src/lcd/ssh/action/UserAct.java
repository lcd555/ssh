...
import lcd.ssh.service.UserService;
import lcd.ssh.utils.JsonUtils;
import lcd.ssh.utils.MyUtils;
...
public class UserAct extends ActionSupport {
    ...
    private String uid,password; //属性值来源于前端同名传输来的数据
    ...
    public String doLogin(){ 
        try { 
            ...
            User user = userService.findUserByUidAndPwd(uid, password); 
            jsonobj.clear();
            if(user != null){ 
                jsonobj.put("ok", true);
